...
print(f"{Fore.YELLOW}Would you like the bot to apply your skins?")
while True:
    apply_skins = input("> ")
    if apply_skins == "n":
        apply_skins = False
        ...
        print(f"{Fore.RED}Make sure to only enter {Fore.BLUE}\"y\"{Fore.YELLOW} or {Fore.BLUE}\"n\"{Fore.YELLOW}")
