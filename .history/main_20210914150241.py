...
def promptUser():
    ...
    print(f"Setting up auto-apply bot with email \""+email+"\"...\n")
    print(f"Once started, your browswer will open, to cache skins on NameMC")
    print(f"DO NOT USE YOUR PC while the skins are being applied.")
    print(f"This process will take 4-8 minutes or so.")
