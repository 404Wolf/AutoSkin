...
for skin in range(27):
    ...
    print(f"{Fore.GREEN}Skin {Fore.GREEN}{str(skin)}{Fore.GREEN} applied successfully")
    ...
    print(f"{Fore.GREEN}Skin {Fore.BLUEEN}{str(skin)}{Fore.GREEN} cached on NameMC successfully")
