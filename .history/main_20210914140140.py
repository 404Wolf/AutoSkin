...
def promptUser():
    ...
    print(f"{Fore.YELLOW}Input your account's email{Fore.YELLOW}")
    while True:
        email = input(">")
        if "@" in email: #make sure it's a real email
            ...
            print(f"{Fore.RED}Make sure to enter a valid email!")

    #prompt user for account's password
    print(f"{Fore.YELLOW}Input your account's password")
    password = input(">")
    print()
