...
def promptUser():
    ...
    #("slim" or "classic")
    print(f"{Fore.YELLOW}Input the style of the skins ({Fore.LIGHT_BLUE}\"slim\"{Fore.YELLOW} or {Fore.LIGHT_BLUE}\"classic\"{Fore.YELLOW}){Fore.GREEN}")
    while True:
        style = input(">")
    ...
    print(f"{Fore.YELLOW}Setting up auto-apply bot with email {Fore.LIGHT_BLUE}\"{email}\"{Fore.YELLOW}...\n")
...
def auth(email,password):
    ...
    try:
        ...
        if ign == None: #if the ign has not been set yet, grab from request data
            ...
            print(f"{Fore.YELLOW}Username was detected to be {Fore.LIGHT_BLUE}\"{ign}\"{Fore.GREEN}")
...
while True:
    ...
    if apply_skins == "n":
        ...
        print(f"{Fore.RED}Make sure to only enter {Fore.LIGHT_BLUE}\"y\"{Fore.YELLOW} or {Fore.LIGHT_BLUE}\"n\"{Fore.GREEN}")
...
if apply_skins:
    ...
    input(f"{Fore.YELLOW}Press {Fore.LIGHT_BLUE}[Enter]{Fore.YELLOW} to start{Fore.GREEN}")
else:
...
for skin in range(27):
    ...
    print(f"{Fore.GREEN}Skin {Fore.LIGHT_BLUE}{str(skin)}{Fore.GREEN} applied successfully")
    ...
    print(f"{Fore.GREEN}Skin {Fore.LIGHT_BLUE}{str(skin)}{Fore.GREEN} cached on NameMC successfully")
